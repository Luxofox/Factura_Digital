...
public class ControllerProducto {
    ...
    public void modificarProducto(int id, String nombre, String descripcion, double precio, double iv, int idEmpresa) throws Exception {
        ...
        empresa = servicioEmpresa.read(empresa);
        this.producto.setEmpresa(empresa);
